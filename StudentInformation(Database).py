...
class Student_Information:
    ...
    def __init__(self, root):
        ...
        self.Search_choice = ttk.Combobox(self.First_Frame, textvariable=self.Search_by, font=('Lato', 12), state='readonly',
                                                    values=['ID_Number', 'Full_Name', 'Course_Code'], width=10)
        ...
        self.Refresh_button = Button(self.First_Frame, text='Refresh', command=self.refresh, font=('Century Gothic', 10), bg='#ffffff', relief=GROOVE)
        ...
        self.Below_Frame.place(y=550, width=1199, height=51)

        self.List = Label(self.Below_Frame, text='NUMBER OF STUDENTS:', font=('Century Gothic', 17, 'bold'), fg='#fefefe', bg='#fb8263')
        self.List.grid(row=0, column=3, padx=855, pady=6, sticky='w')
        self.List_entry = Entry(self.Below_Frame, font=('Lato', 12), bd=2, relief=RIDGE, width=8)
        self.List_entry.grid(row=0, column=3, padx=1105, sticky='w')
